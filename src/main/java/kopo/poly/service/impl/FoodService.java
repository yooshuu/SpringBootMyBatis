...
public class FoodService implements IFoodService {
    ...
    public List<FoodDTO> toDayFood() throws Exception {
        ...
        while (foodIt.hasNext()) {
            ...
            /*
             * 수집되는 데이터 예)
             * 월요일 백미밥 , 돼지국밥&소면(돈육 국산) , 동태전&호박전 , 골뱅이무침 , 김치 , 망고깍두기
             * 화요일 잡곡밥 , 털레기수제비 , 삼치구이(국산) , 매콤감자조림 , 노각무침 , 김치
             * 수요일 닭다리녹두죽(국산) , 추가밥 , 김치부침개 , 채소스틱 , 청포묵김무침/석박지 , 수박
             * 목요일 잡곡밥 , 소고기무국(우육 호주산) , 코다리조림(러시아) , 팽이버섯계란전 , 재래김 , 콩나물무침 , 김치
             * 금요일 미트소스 스파게티, 옥수수스프, 몬테크리스토토스트, 피클, 추가밥, 추가김치
             * 토요일
             * 일요일
             */
