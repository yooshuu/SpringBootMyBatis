...
public class EncryptUtil {
    ...
    /**
     * SHA-256 해시 암호화시 사용할 추가 문자열 (Salt 개념)
    ...
    public static String encHashSHA256(String str) {
        String result; // 암호화 결과값이 저장되는 변수
        String plainText = addMessage + str; // 암호화 시킬 값에 보안 강화를 위해 임의 값을 추가함
