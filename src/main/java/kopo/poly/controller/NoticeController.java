...
public class NoticeController {
     ...
     * 게시판 리스트 보여주기
     * <p>
     * GetMapping(values = "notice/noticeList") => GET방식을 통해 접속되는 URL이 notice/noticeList 경우 아래 함수를 실행함
     */
    ...
    public String noticeInfo(HttpServletRequest request, ModelMap model) throws Exception {
        ...
        log.info("{}.noticeInfo.jsp Start!", this.getClass().getName());
        ...
        log.info("{}.noticeInfo.jsp End!", this.getClass().getName());

        // 함수 처리가 끝나고 보여줄 JSP 파일명
        // webapp/WEB-INF/view/notice/noticeInfo.jsp.jsp
    ...
    public String noticeEditInfo(HttpServletRequest request, ModelMap model) throws Exception {
        ...
        // 함수 처리가 끝나고 보여줄 JSP 파일명
        // webapp/WEB-INF/view/notice/noticeEditInfo.jsp
