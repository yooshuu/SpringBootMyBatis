...
<%@ page import="org.springframework.cache.config.CacheManagementConfigUtils" %>
<%
        ...
        <div class="divTableBody">
            <div class="divTableRow">
                ...
                <div class="divTableCell">
                    <input type="password" name="password" id="password" sytle="width:95%"/>
                </div>
            </div>
            <div class="divTableRow">
                ...
                <div class="divTableCell">
                    <input type="password" name="password2" id="password2" sytle="width:95%"/>
                </div>
            </div>
        </div>
    </div>
